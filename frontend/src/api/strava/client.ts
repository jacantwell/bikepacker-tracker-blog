...
export class StravaClient {
  ...
  constructor(
    ...
    this.clientId = clientId || import.meta.env.VITE_STRAVA_CLIENT_ID || '';
    this.clientSecret = clientSecret || import.meta.env.VITE_STRAVA_CLIENT_SECRET || '';
    this.refreshToken = refreshToken || import.meta.env.VITE_STRAVA_REFRESH_TOKEN || '';
